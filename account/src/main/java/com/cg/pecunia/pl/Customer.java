...
public class Customer {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			/*
			 * case 3: try { address = new Address();
			 * System.out.println("update account details");
			 * System.out.println("enter account number"); String acc = sc.next(); account =
			 * accountService.findAccount(acc); System.out.println("update contact"); String
			 * contact = sc.next(); account.setAccountContact(contact);
			 * System.out.println("update address"); System.out.println("update house no:");
			 * String hno = sc.next(); address.setCity(hno);
			 * System.out.println("update city"); String city = sc.next();
			 * address.setCity(city); System.out.println("update state"); String state =
			 * sc.next(); address.setState(state); System.out.println("update pin"); String
			 * pin = sc.next(); address.setPincode(pin); account.setAccountAddress(address);
			 * 
